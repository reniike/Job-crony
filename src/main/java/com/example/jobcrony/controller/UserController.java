...
public class UserController {
    ...
    public ResponseEntity<GenericResponse<String>> resetPassword(@RequestBody ResetPasswordRequest request) throws UserNotFoundException, InvalidTokenException {
