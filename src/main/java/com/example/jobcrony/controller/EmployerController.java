...
public class EmployerController {
    ...
    public ResponseEntity<GenericResponse<String>> register(@RequestBody EmployerRegistrationRequest request) throws CompanyNotFoundException, LimitExceededException {
